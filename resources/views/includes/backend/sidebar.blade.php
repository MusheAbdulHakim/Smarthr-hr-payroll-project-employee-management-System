            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        <li><a class="{{ Request::routeIs('dashboard') ? 'active' : '' }}" href="{{route('dashboard')}}">Admin Dashboard</a></li>
                ...
                <li class="submenu">
                    ...
                    <ul style="display: none;">
                        ...
                        <li><a class="{{ Request::routeIs('events') ? 'active' : '' }}" href="{{route('events')}}">Calendar</a></li>
