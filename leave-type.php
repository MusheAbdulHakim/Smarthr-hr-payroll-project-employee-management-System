    ...
    <body>
        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
				...
				<!-- Add Leavetype Modal -->
				<?php include_once("includes/modals/leave/type/add.php"); ?>
				<!-- /Add Leavetype Modal -->
				
				<!-- Edit Leavetype Modal -->
				<?php include_once("includes/modals/leave/type/edit.php"); ?>
				<!-- /Edit Leavetype Modal -->
				
				<!-- Delete Leavetype Modal -->
				<?php include_once("includes/modals/leave/type/delete.php"); ?>
				<!-- /Delete Leavetype Modal -->
